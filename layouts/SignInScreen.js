            ...
            >
                ...
                {data.isValidUser ? null :
                    <Animatable.View animation="fadeInLeft" duration={500}>
                        <Text style={styles.errorMsg}>El usuario tener una longitud mínima de 4 caracteres.</Text>
                    </Animatable.View>
                }
                ...
                {data.isValidPassword ? null :
                    <Animatable.View animation="fadeInLeft" duration={500}>
                        <Text style={styles.errorMsg}>La contraseña debe tener una longitud mínima de 8 caracteres</Text>
                    </Animatable.View>
                }
                <TouchableOpacity>
